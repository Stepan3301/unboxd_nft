 ...
 * 
 * This script contains three enhanced functions:
 * 1. shuffleArray - For randomizing the NFT order
 * 2. initializeRoulette - For creating randomized order in the roulette
 * 3. startRouletteAnimation - For improved animation physics
 * 4. openCase - Updated to use the new animation function
 */

// 1. ADD THIS FUNCTION - Shuffle array using Fisher-Yates algorithm
...
// 2. REPLACE initializeRoulette WITH THIS VERSION
...
// 3. REPLACE startRouletteAnimation WITH THIS VERSION
...
// 4. REPLACE openCase WITH THIS VERSION
async function openCase(caseId) {
    try {
        ...
        // Start the enhanced animation with the selected skin
